...
[See an example up and running](https://www.youtube.com/watch?v=STtpXBvJmDA)
...
```sh
git clone git@github.com:yieldprotocol/yield-web.git
cd yield-web
npm install
...
>
> Fork or clone the site to your GitHub account. After adding your repo to Netlify you’ll get automatic builds & deploys when pushing to master. You can also add a [webhook](https://www.sanity.io/docs/webhooks) to get deploys on content changes.
